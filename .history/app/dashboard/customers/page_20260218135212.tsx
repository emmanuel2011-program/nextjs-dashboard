  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white shadow rounded-md overflow-auto max-h-[90vh] space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <input type="text" name="BankDetails" placeholder="Bank Account / Bank Name" value={formData.altBankName} onChange={handleChange} className="border p-2 rounded w-full"/>
