  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white shadow rounded-md overflow-auto max-h-[90vh] space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        {/* Loan/Agreement */}
        <div className="mt-6">
          <label className="block mb-2 font-semibold">Loan/Facility Agreement</label>
          <TextareaAutosize
            name="agreementText"
            value={formData.agreementText}
            onChange={handleChange}
            placeholder={`I, ………………………………………………………………. Whose name and residential address as above stated, agrees to accept the terms and conditions of SHH MCS, whose address as above. Here by agree to apply for loan/facility to the tune of ……………………………………………………………………………………………only, with a monthly payment of ………………………………..representing ………………………………………of the said amount, which would last for a month or depending on the renewal status. The new monthly payment of the said interest after which the said amount…………………………..would be refunded. This agreement runs from …………………..to ……………………………`}
            minRows={6}
            className="w-full border p-2 rounded-md"
          />
        </div>

        <button type="submit" className="bg-blue-500 text-white px-6 py-2 rounded hover:bg-blue-400">
          Submit
        </button>
      </form>
    </div>
