  ...
  return (
    <div className="max-w-6xl mx-auto p-6 bg-white shadow rounded-md overflow-auto max-h-[90vh] space-y-6">
      ...
      <form onSubmit={handleSubmit} className="space-y-6">
        ...
        <input type="text" name="bankDetails" placeholder="Bank Name / Account Number / Acc Type" value={formData.bankDetails} onChange={handleChange} className="border p-2 rounded w-full"/>
        ...
        {/* Employment */}
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <input type="month" name="Date Loan request" placeholder="Date of Loan request" value={formData.dateOfEmployment} onChange={handleChange} className="border p-2 rounded"/>
